package Z27.br.com.blue.jakson.criando.sockets.serviço.processamento.pagamentos.TCP.IP�o.processamento.pagamentos.TCP.IP;
	...
	public static void main(String[] args) throws Exception {
		...
		while (true) {
			...
			if (tipo.equals("PAGAMENTO")) {
				...
				// Processar outros tipos de requisi��o
			}
		}
	}
	...
	private static void processarPagamento(BufferedReader in, PrintWriter out) {
		...
		for (int i = 0; i < qtde; i++) {
			try {
				...
				System.out.println("Data de validade do cart�o:" + dataValidadeCartao);
