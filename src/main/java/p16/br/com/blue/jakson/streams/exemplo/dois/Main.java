...
//		executar2();
	...
	private static void executar1() {
		// 1. Ordenar os produtos por pre�o
		// 2. Converter os pre�os em d�lar
		// 3. Mostrar os dados do produto na tela

		double cotacao = 4;

		produtos.stream().sorted((e1, e2) -> Double.valueOf(e1.getPreco()).compareTo(e2.getPreco()))
	...
	private static void executar2() {
		// 1. Criar um Map onde a chave � o ID e o valor � o nome do produto
	...
	private static void executar3() {
		// 1. Criar uma representa��o de texto dos produtos
