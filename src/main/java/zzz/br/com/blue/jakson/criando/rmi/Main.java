package zzz.br.com.blue.jakson.criando.rmi;
...
public class Main {
	...
	public static void main(String[] args) throws Exception {
		...
		// ContaBancaria contaStub1 = (ContaBancaria)
		// UnicastRemoteObject.exportObject(conta1, 0);

		ContaBancaria conta2 = new ContaBancariaImpl();
		// ContaBancaria contaStub2 = (ContaBancaria)
		// UnicastRemoteObject.exportObject(conta2, 0);
